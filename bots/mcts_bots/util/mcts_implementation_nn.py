...
from bots.mcts_bots.util.mcts_game_state_nn import MCTSGameStateNN
...
class ISMCTSNN:
    ...
    def search(self):
        ...
        for _ in range(self.iterations):
            ...
            self.root.state = MCTSGameStateNN.random_state_from_obs(self.obs)  # Step 1: Determinization - sample a possible complete game state
...
class ISMCTSNode:
    ...
    def __init__(self, parent: ISMCTSNode | None = None, action: int | None = None, c_param: float = 1.3):
        ...
        self.state: MCTSGameStateNN | None = None          # Associated game state
